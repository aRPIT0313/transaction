...
# Split features and labels
X = merged_transaction_dataset[['transaction_month', 'transaction_hour', 'transferred_amount', 'amount_before_transaction', 'amount_after_transaction', 'transaction_mode_Online']]
...
svm_clf = SVC(kernel='sigmoid', C=1.0)
